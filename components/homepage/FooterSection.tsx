  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-orange-900 text-white py-20 relative overflow-hidden" id="contact">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-10 right-10 w-64 h-64 bg-orange-500/10 rounded-full mix-blend-multiply blur-xl opacity-60 animate-pulse delay-500"></div>
        <div className="absolute bottom-10 left-10 w-80 h-80 bg-orange-400/10 rounded-full mix-blend-multiply blur-xl opacity-40 animate-pulse delay-1000"></div>
      </div>
