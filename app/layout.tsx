...
export const metadata = {
  ...
  description:
    "Comprehensive library seat management and student tracking system with real-time availability, email reminders, and admin dashboard.",
  keywords: [
    "student management",
    "library management",
    "seat booking",
  ...
  openGraph: {
    ...
    description:
      "Manage library seats, track student records, and send automated reminders with our comprehensive student management system.",
    siteName: "StudyFi Library",
    images: [{ url: "/study-fi-logo.svg", width: 1200, height: 630, alt: "Study-Fi Library" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "StudyFi Library - Amravati's Best Study Library",
    description:
      "Manage library seats, track student records, and send automated reminders.",
    images: ["/og-image.png"],
  },
      ...
      <head>
        ...
        <Script id="google-analytics" strategy="afterInteractive">
          {/* {/* {
            ...
            gtag('js', new Date());
            gtag('config', 'G-GCXJX0NMKZ', { page_path: window.location.pathname }); */}
